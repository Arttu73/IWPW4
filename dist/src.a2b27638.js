...
var inputText = document.getElementById("input-show");
...
submitButton.addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var url2, dataPromise, dataJSON;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        url2 = url + inputText.value;
        _context.prev = 1;
        _context.next = 4;
        return fetch(url2);
      case 4:
      ...
      case 7:
        ...
        dataJSON.forEach(function (data) {
          var _data$show$image;
          var imgURL = (_data$show$image = data.show.image) === null || _data$show$image === void 0 ? void 0 : _data$show$image.medium;
          var summary = data.show.summary;
          var title = data.show.name;
      ...
      case 11:
        ...
        console.error("Error fetching or parsing data:", _context.t0);
      case 14:
      case "end":
